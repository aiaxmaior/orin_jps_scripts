/*
 * DeepStream application with proximity distance overlay - YOLOv8n-seg version
...
#define IMAGE_HEIGHT 640.0

/* Known object heights (meters) for COCO classes */
static float get_object_height(int class_id) {
    switch(class_id) {
        case 0:  return 1.7;   // person
        case 1:  return 1.2;   // bicycle
        case 2:  return 1.5;   // car
        case 3:  return 1.3;   // motorcycle
        case 5:  return 3.0;   // bus
        case 6:  return 3.5;   // train
        case 7:  return 2.5;   // truck
        case 9:  return 3.0;   // traffic light
        case 11: return 2.0;   // stop sign
        default: return 1.5;   // default
    }
}
...
osd_sink_pad_buffer_probe (GstPad * pad, GstPadProbeInfo * info, gpointer u_data)
{
    ...
    for (l_frame = batch_meta->frame_meta_list; l_frame != NULL;
        ...
        for (l_obj = frame_meta->obj_meta_list; l_obj != NULL;
            ...
            float real_height = get_object_height(obj_meta->class_id);
...
main (int argc, char *argv[])
{
    ...
    /* Create elements */
    pipeline = gst_pipeline_new ("deepstream-proximity-yolo-pipeline");
    ...
    /* Set properties for YOLOv8n-seg */
    ...
    g_object_set (G_OBJECT (nvinfer),
                  "config-file-path", "config_infer_yolov8n-seg.txt", NULL);
    ...
    /* Start playing */
    g_print ("Running DeepStream YOLOv8n-seg with proximity sensor...\n");
